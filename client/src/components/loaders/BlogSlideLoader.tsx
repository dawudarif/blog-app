export default function BlogSlideLoader() {
  return (
    <div className='bg-stone-100 rounded-lg p-4 gap-4 flex xs:flex-col sm:flex-col cursor-pointer transition duration-500 w-full animate-pulse'>
      <div className='h-40 w-50 object-cover bg-stone-300 w-[50%] xs:w-full sm:w-full'></div>
      <div className='flex-col flex gap-8 w-[50%] xs:w-full sm:w-full'>
